...
![Schéma simple fonctionnement EAP avec intermédiaire Authenticator](/static/img/Frame_50.png)
...
![Schéma d'un requête EAP](/static/img/Frame_53(1).png)

Identity request correspond à la demande du username au client par l'authenticator

Identity response est ce nom d'utilisateur, cette information est demandée pour permettre à l'Authentication Server de savoir quelle challenge demander, il existe plusieurs types de challenge en voici quelques un

- (simple mot de passe hashé avec MD5, cette méthode est controversée car MD5 n'est pas considéré comme sécurisé).
